...
def train(max_len=20, hidden=64, head=4, batchsize=64, epochs=1, steps_per_epoch=None, tensorboard=False, tb_dir='logs', model_dir='de2en'):
    """
    Train the model
    """
...
def predict(input_string, max_len=20, model_dir='de2en'):
